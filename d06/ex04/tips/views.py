...
def delete_tip(request, tip_id):
    """
    Ex04 : Suppression restreinte.
    - Auteur du tip : toujours autorisé (exception du sujet).
    - Autres users : nécessite la permission Django 'tips.delete_tip'.
    - Retrait du bouton dans le template en plus de la vérification côté serveur.
    """
    tip = get_object_or_404(Tip, id=tip_id)
    user = request.user
